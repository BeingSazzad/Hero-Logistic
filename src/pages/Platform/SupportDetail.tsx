        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className={`text-xs font-semibold uppercase  py-1 rounded ${pCfg.bg} ${pCfg.text}`}>{ticket.priority} Priority</span>
              {isResolved && <span className="text-xs font-semibold uppercase  py-1 rounded bg-gray-200 text-gray-600">Resolved</span>}
            </div>
