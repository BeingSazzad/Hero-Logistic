    ...
    <div className="flex flex-col bg-[#F8FAFC] min-h-screen w-full max-w-[480px] mx-auto relative">
      ...
      <div className="h-[360px] bg-[#111] relative overflow-hidden shrink-0 pt-10">
         ...
         <button 
            ...
            className="absolute top-4 right-4 w-12 h-12 bg-black/40 backdrop-blur-md border border-white/20 rounded-hero-md flex items-center justify-center text-white z-50 hover:bg-black/60 active:scale-95 transition-all shadow-2xl"
         >
            <X size={24} />
         </button>
         ...
         {/* Instruction HUD */}
         <div className="absolute inset-x-4 top-4 bg-white/10 backdrop-blur-xl border border-white/10 rounded-hero-lg p-4 shadow-2xl z-20">
            <div className="flex items-center gap-4">
               <div className="w-12 h-12 bg-brand-yellow rounded-hero-md flex items-center justify-center shadow-lg shadow-brand-yellow/20 shrink-0">
         ...
         <div className="absolute bottom-4 right-4 flex flex-col gap-2">
            <button className="w-12 h-12 bg-[#111]/80 backdrop-blur-md border border-white/10 rounded-hero-md flex items-center justify-center text-white text-lg font-bold shadow-xl">+</button>
            <button className="w-12 h-12 bg-[#111]/80 backdrop-blur-md border border-white/10 rounded-hero-md flex items-center justify-center text-white text-lg font-bold shadow-xl">-</button>
         </div>
      </div>
       ...
       <div className="px-4 pb-20 space-y-4 -mt-10 relative z-30">
         ...
         {/* Main action card */}
         <div className="bg-white rounded-hero-lg p-6 pb-10 shadow-2xl border border-gray-100 flex flex-col items-center text-center">
           <div className="space-y-4 w-full mb-6">
              ...
              <div className="bg-[#111] rounded-hero-md p-4 flex items-center justify-between shadow-xl border border-white/5">
           ...
           <div className="w-full space-y-4">
            {step === 'EnRoute' && (
              <div className="flex flex-col gap-4">
                 <button
                   ...
                   className="w-full bg-[#161B22] hover:bg-black text-brand-yellow font-semibold uppercase text-sm py-5 rounded-hero-md flex items-center justify-center gap-3 active:scale-[0.98] transition-all shadow-xl"
                 >
                   <CheckCircle2 size={20} /> Confirm Arrival
                 </button>
                 <div className="flex gap-3">
                    <button className="flex-1 items-center justify-center py-4 bg-white border border-gray-100 text-gray-600 font-bold text-xs rounded-hero-md flex flex-col gap-1.5 shadow-sm active:scale-95 transition-all">
                       <Phone size={18} className="text-gray-400"/> Call Site
                    </button>
                    <button className="flex-1 items-center justify-center py-4 bg-white border border-gray-100 text-[#FF6B00] font-bold text-xs rounded-hero-md flex flex-col gap-1.5 shadow-sm active:scale-95 transition-all">
            ...
            {step === 'Arrived' && (
              <div className="space-y-4">
                 <div className="bg-emerald-50 text-emerald-900 p-8 rounded-hero-lg border border-emerald-100 flex flex-col items-center">
                 ...
                 <button
                   ...
                   className="w-full bg-[#111] hover:bg-black text-brand-yellow font-semibold uppercase text-sm py-6 rounded-hero-md flex items-center justify-center gap-3 active:scale-[0.98] transition-all shadow-xl"
                 >
            ...
            {step === 'Unloading' && (
              <div className="space-y-4">
                 <div className="grid grid-cols-2 gap-3">
                   <button className="flex flex-col items-center justify-center gap-2 p-5 bg-gray-50 border border-gray-100 rounded-hero-md hover:bg-gray-100 transition-colors">
                 ...
                 <button
                   ...
                   className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm py-3.5 rounded-hero-md flex items-center justify-center gap-2 active:scale-95 transition-all shadow-sm"
                 >
                   Complete &amp; Upload
                 </button>
              </div>
                 ...
                 <p className="text-xs font-semibold text-gray-500 mt-2 mb-6 leading-relaxed">Evidence and signatures successfully synced.</p>
                  <div className="flex flex-col gap-3 w-full">
                     <button
                       ...
                       className="w-full bg-orange-50 text-orange-600 font-bold text-sm py-4 rounded-hero-md flex items-center justify-center gap-2 active:scale-95 transition-all shadow-sm border border-orange-100 whitespace-nowrap"
                     >
                       <CreditCard size={18} /> Log Trip Tolls / Expenses
                     </button>
                     <button
                       onClick={() => navigate('/driver')}
                       className="w-full bg-gray-900 hover:bg-black text-white font-bold text-sm py-4 rounded-hero-md flex items-center justify-center gap-2 active:scale-95 transition-all shadow-sm whitespace-nowrap"
                     >
                       Back to Dashboard
                     </button>
                  </div>
         ...
         {/* Shift Summary */}
         <div className="bg-white rounded-hero-md p-5 shadow-sm border border-gray-100">
           ...
           <div className="grid grid-cols-2 gap-3">
             <div className="bg-gray-50 p-4 rounded-hero-md border border-gray-100">
