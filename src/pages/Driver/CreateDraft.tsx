  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-8 text-center animate-in zoom-in-90 duration-300">
        <div className="w-28 h-28 bg-brand-yellow rounded-full w-fit flex items-center justify-center mb-8 shadow-2xl shadow-brand-yellow/30 animate-bounce">
      ...
      <div className="px-5 pt-6 flex flex-col gap-5">
                ...
                className={`flex-1 py-3.5 rounded-2xl text-xs font-semibold uppercase tracking-widest border-2 transition-all ${
                  urgency === u
                    ? u === 'High'
                      ...
                      : 'border-[#111] bg-[#111] text-brand-yellow'
        ...
        <button
          ...
          className={`py-5 rounded-3xl font-semibold uppercase tracking-[0.1em] text-sm flex items-center justify-center gap-3 transition-all shadow-xl active:scale-[0.97] ${
            canSubmit
              ? 'bg-[#111] text-brand-yellow hover:bg-black shadow-black/20'
