      ...
      <div className="flex flex-col bg-gray-50 min-h-screen pb-24 w-full max-w-[480px] mx-auto animate-in slide-in-from-bottom-5 duration-300">
        ...
        <div className="bg-[#111] px-6 pt-12 pb-6 shadow-xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-brand-yellow flex items-center justify-center text-black shadow-lg">
              <Receipt size={24} />
            </div>
            <div>
        ...
        <div className="p-6 space-y-5">
              ...
              {categories.map(cat => (
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-4 rounded-2xl border-2 transition-all text-center ${
                    category?.id === cat.id
                      ? 'border-brand-yellow bg-[#111] text-white'
                      : 'border-gray-100 bg-white text-gray-600 hover:border-gray-300'
                  }`}
                >
                  <cat.icon size={22} className={category?.id === cat.id ? 'text-brand-yellow' : ''} />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full bg-white border-2 border-gray-100 py-4 pl-10 pr-5 rounded-2xl text-2xl font-semibold focus:outline-none focus:ring-4 focus:ring-brand-yellow/10 focus:border-brand-yellow transition-all shadow-sm"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-white border-2 border-gray-100 py-4 px-5 rounded-2xl text-sm font-semibold focus:outline-none focus:ring-4 focus:ring-brand-yellow/10 focus:border-brand-yellow transition-all shadow-sm"
            />
          </div>
          ...
          <button
            ...
            className={`w-full py-8 border-2 rounded-[2.5rem] flex flex-col items-center justify-center gap-3 transition-all cursor-pointer ${
              receiptCaptured
                ...
                : 'border-dashed border-gray-100 bg-white text-gray-400 hover:border-brand-yellow hover:bg-brand-yellow/5'
            }`}
          >
            {receiptCaptured ? (
              <>
          ...
          <button
            ...
            className={`btn-cta mt-2 shadow-xl ${
              category && amount
                ? 'bg-[#111] hover:bg-black text-brand-yellow'
  ...
  if (step === 'success') {
    return (
      <div className="flex flex-col items-center justify-center bg-gray-50 min-h-screen p-8 text-center animate-in zoom-in-95 duration-300">
        <div className="w-28 h-28 bg-brand-yellow rounded-full w-fit flex items-center justify-center text-black mb-8 shadow-2xl shadow-brand-yellow/30 animate-bounce">
        ...
        <button
          ...
          className="btn-cta mt-8 bg-[#111] text-brand-yellow hover:bg-black shadow-lg"
        >
          Back to Expenses
        </button>
      </div>
    ...
    <div className="flex flex-col bg-gray-50 min-h-screen pb-24 w-full max-w-[480px] mx-auto">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="text-xs font-medium text-brand-yellow mt-2">Awaiting Approval</p>
            </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <button
          ...
          className="btn-cta bg-brand-yellow hover:bg-brand-yellow text-black shadow-lg border border-yellow-300"
        >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="w-1 h-1 bg-gray-200 rounded-full w-fit" />
