...
const RAW_CUSTOMERS = [
  { id: 'CUST-001', name: 'Acme Corp Logistics',      contact: 'John Smith',   email: 'john@acme.com.au',    phone: '+61 411 000 001', creditLimit: 50000,  terms: 'Net 30', status: 'Active',    Loads: 142, revenue: '$28,400', rating: 4.8, logo: 'https://images.unsplash.com/photo-1599305090748-364e7756771a?q=80&w=300&auto=format&fit=crop' },
  { id: 'CUST-002', name: 'Tech Solutions Ltd',       contact: 'Emma Watson',  email: 'emma@techsol.com',    phone: '+61 412 000 002', creditLimit: 10000,  terms: 'Net 14', status: 'Active',    Loads: 38,  revenue: '$7,200',  rating: 4.5, logo: 'https://images.unsplash.com/photo-1599305090748-364e7756771a?q=80&w=300&auto=format&fit=crop' },
  { id: 'CUST-003', name: 'Global Traders Australia', contact: 'Lucas Brown',  email: 'lucas@globaltr.com',  phone: '+61 413 000 003', creditLimit: 150000, terms: 'Net 60', status: 'On Hold',   Loads: 0,   revenue: '$0',      rating: 3.2, logo: '/logo.png' },
  { id: 'CUST-004', name: 'Fresh Markets AU',         contact: 'Ben Chu',      email: 'ben@freshmarkets.com', phone: '+61 414 000 004', creditLimit: 25000,  terms: 'Net 14', status: 'Active',    Loads: 89,  revenue: '$14,600', rating: 4.9, logo: 'https://images.unsplash.com/photo-1599305090748-364e7756771a?q=80&w=300&auto=format&fit=crop' },
  { id: 'CUST-005', name: 'Southport Logistics',      contact: 'Sarah Miller', email: 'sarah@southport.com', phone: '+61 415 000 005', creditLimit: 80000,  terms: 'Net 30', status: 'Active',    Loads: 204, revenue: '$41,300', rating: 4.7, logo: 'https://images.unsplash.com/photo-1599305090748-364e7756771a?q=80&w=300&auto=format&fit=crop' },
  { id: 'CUST-006', name: 'Blue River Exports',       contact: 'Mike Tan',     email: 'mike@blueriver.com',  phone: '+61 416 000 006', creditLimit: 5000,   terms: 'Net 7',  status: 'Suspended', Loads: 0,   revenue: '$0',      rating: 2.8, logo: 'https://images.unsplash.com/photo-1599305090748-364e7756771a?q=80&w=300&auto=format&fit=crop' },
];
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-[1440px] mx-auto pb-12">
      <div className="flex justify-between items-center mb-2 ">
        ...
        <button onClick={() => navigate('/admin/customers/add')} className="bg-brand-yellow hover:bg-brand-orange text-black px-6 py-2.5 rounded-lg font-bold flex items-center gap-2 transition-all shadow-sm">
          ...
          <div className="flex gap-3 items-center w-full xl:w-auto">
            <div className="relative flex-1 xl:w-72">
              ...
              <input type="text" value={search} onChange={e => setSearch(e.target.value)}
                placeholder="Search by Company or ID..." className="w-full bg-white border border-gray-200 rounded-lg py-2.5 pl-10 pr-4 text-sm font-normal text-gray-900 focus:outline-none focus:ring-2 focus:ring-brand-yellow/20 focus:border-brand-yellow hover:border-gray-300 transition-all shadow-sm" />
            </div>
            <div className="relative">
              <select value={sortKey} onChange={e => setSortKey(e.target.value)}
                className="appearance-none bg-white border border-gray-200 hover:border-gray-300 text-gray-900 text-sm font-normal rounded-lg pl-9 pr-10 py-2.5 focus:outline-none focus:ring-2 focus:ring-brand-yellow/20 cursor-pointer shadow-sm">
