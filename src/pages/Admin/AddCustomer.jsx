        ...
        <div className="md:col-span-2 flex flex-col gap-6">
          <div className="bg-white rounded-xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 overflow-hidden">
             <div className="p-5 border-b border-gray-100 bg-[#FAFAFA] flex items-center gap-3">
               <Building2 className="text-brand-yellow" size={18} />
               <div>
             ...
             <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
               <div>
                  ...
                  <input type="text" placeholder="e.g. Acme Corp Logistics" className="w-full bg-white border border-gray-200 focus:border-brand-yellow rounded-lg py-2.5 px-4 text-sm font-medium text-gray-900 shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-brand-yellow/20" />
               </div>
               <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-1.5 ml-1">ABN / Business ID</label>
                  <input type="text" placeholder="11-digit ABN" className="w-full bg-white border border-gray-200 focus:border-brand-yellow rounded-lg py-2.5 px-4 text-sm font-medium text-gray-900 shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-brand-yellow/20" />
               </div>
               <div className="md:col-span-2">
                  ...
                  <div className="relative group">
                     ...
                     <input type="text" placeholder="Street Address" className="w-full bg-white border border-gray-200 focus:border-brand-yellow rounded-lg py-2.5 pl-12 pr-4 text-sm font-medium text-gray-900 shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-brand-yellow/20" />
                  </div>
               </div>
               <div className="md:col-span-2">
                  ...
                  <div className="relative group">
                     ...
                     <input type="email" placeholder="accounts@company.com" className="w-full bg-white border border-gray-200 focus:border-brand-yellow rounded-lg py-2.5 pl-12 pr-4 text-sm font-medium text-gray-900 shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-brand-yellow/20" />
                  </div>
               </div>
             </div>
          </div>
        ...
        <div className="md:col-span-1 flex flex-col gap-6">
           ...
           <div className="bg-white rounded-xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 overflow-hidden">
             ...
             <label className="flex items-center justify-center gap-2 cursor-pointer font-bold text-gray-700 py-4 hover:bg-gray-50 transition-colors">
               <input type="checkbox" className="w-4 h-4 accent-brand-yellow" defaultChecked /> 
