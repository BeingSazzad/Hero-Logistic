        ...
        <div className="p-5 border-b border-gray-100 flex justify-between items-center bg-[#FAFAFA]">
          <div className="relative w-[320px] group">
            ...
            <input
              ...
              className="w-full bg-white border border-gray-200 rounded-lg py-2.5 pl-10 pr-4 text-sm font-normal text-gray-900 focus:outline-none focus:ring-2 focus:ring-brand-yellow/20 focus:border-brand-yellow transition-all shadow-sm"
            />
          </div>
              ...
              {filteredFleet.map(v => (
                <tr className="hover:bg-gray-50/50 transition-all cursor-pointer group" key={v.id} onClick={() => navigate(`/dispatch/vehicles/${v.id}`)}>
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-gray-50 flex items-center justify-center border border-gray-200 shrink-0 group-hover:border-brand-yellow transition-colors">
                  ...
                  <td className="px-6 py-5 text-right">
                    ...
                    <div className="w-16 h-1.5 bg-gray-100 rounded-full w-fit overflow-hidden mt-1 ml-auto">
                      <div className={`h-full ${parseInt(v.fuel) > 50 ? 'bg-emerald-500' : 'bg-red-500'} rounded-full w-fit`} style={{ width: v.fuel || '0%' }}></div>
                    </div>
                  </td>
