      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start ">
        ...
        <div className="w-full lg:w-[300px] shrink-0 flex flex-col gap-2">
          {tabs.map((tab) => (
            ...
            >
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 shadow-sm ${activeTab === tab.id ? 'bg-[#FACC15] text-black' : 'bg-gray-100 text-gray-400'}`}>
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-8 flex flex-col md:flex-row items-center gap-8 bg-gradient-to-br from-white to-gray-50/30">
                  <div className="relative group cursor-pointer">
                    <div className="w-24 h-24 rounded-2xl bg-[#111] flex items-center justify-center text-[#FACC15] text-3xl font-bold transition-transform duration-500">
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input type="text" defaultValue={user.name} className="w-full bg-white border border-gray-200 rounded-xl py-3 px-5 text-sm font-bold focus:ring-2 focus:ring-[#FACC15]/20 focus:border-[#FACC15] outline-none transition-all shadow-sm pl-11" />
            ...
            <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 duration-400">
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-8 space-y-6 max-w-lg">
                  <div className="space-y-2">
                    ...
                    <input type="password" placeholder="••••••••" className="w-full bg-gray-50 border border-gray-100 rounded-xl py-3 px-5 text-sm font-bold text-gray-900 focus:bg-white focus:border-[#FACC15] outline-none transition-all" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-gray-400 uppercase tracking-widest block px-1">New Password</label>
                      <input type="password" placeholder="Min. 8 chars" className="w-full bg-gray-50 border border-gray-100 rounded-xl py-3 px-5 text-sm font-bold text-gray-900 focus:bg-white focus:border-[#FACC15] outline-none transition-all" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-gray-400 uppercase tracking-widest block px-1">Confirm Password</label>
                      <input type="password" placeholder="Confirm" className="w-full bg-gray-50 border border-gray-100 rounded-xl py-3 px-5 text-sm font-bold text-gray-900 focus:bg-white focus:border-[#FACC15] outline-none transition-all" />
                    </div>
                  </div>
                  <button className="bg-[#111] hover:bg-black text-[#FACC15] px-8 py-3.5 rounded-xl font-bold uppercase text-xs tracking-widest transition-all shadow-sm active:scale-95 flex items-center gap-2">
              ...
              <div className="bg-gray-900 rounded-xl p-8 text-white shadow-2xl relative overflow-hidden group">
                ...
                <div className="flex items-center gap-6 relative z-10">
                  <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-[#FACC15] shadow-inner">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-4 mt-6">
                      <button className="bg-[#FACC15] text-black px-6 py-2 rounded-lg font-bold text-xs uppercase tracking-widest shadow-lg hover:bg-yellow-500 transition-all">Enable 2FA</button>
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-4 border border-gray-50 rounded-xl hover:bg-gray-50/50 transition-all border-l-4 border-l-transparent hover:border-l-[#FACC15]">
                      <div className="flex items-center gap-4">
                      ...
                      <input type="checkbox" defaultChecked={s.val} className="w-5 h-5 accent-[#FACC15]" />
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 duration-400">
              ...
              <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] space-y-6">
                <div>
                  ...
                  <input type="text" placeholder="e.g. Rate Config Error, New Branch Req..." className="w-full bg-gray-50 border border-gray-100 focus:border-[#FACC15] focus:bg-white rounded-xl py-4 px-5 text-sm font-bold text-gray-900 shadow-sm transition-all outline-none" />
                </div>
                <div>
                  <label className="hero-metadata block mb-2 px-1">Describe Issue</label>
                  <textarea placeholder="Provide detailed operational issue..." className="w-full min-h-[160px] resize-none bg-gray-50 border border-gray-100 focus:border-[#FACC15] focus:bg-white rounded-xl py-4 px-5 text-sm font-bold text-gray-900 shadow-sm transition-all outline-none" />
                </div>
                <div className="pt-2">
                  <button onClick={() => { alert('Ticket sent to Admin Command Center.'); setActiveTab('profile'); }} className="bg-[#FACC15] hover:bg-[#E6B800] text-black font-semibold uppercase tracking-widest px-8 py-4 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2 w-fit active:scale-95">
