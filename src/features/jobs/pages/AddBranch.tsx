      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                 ...
                 <input 
                   ...
                   className="w-full border border-gray-200 rounded-xl px-5 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand-yellow/20 focus:border-brand-yellow transition-all"
                   value={formData.name}
              ...
              <div className="space-y-2">
                 ...
                 <select 
                   className="w-full border border-gray-200 rounded-xl px-5 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand-yellow/20 focus:border-brand-yellow transition-all appearance-none"
                   value={formData.type}
              ...
              <div className="md:col-span-2 space-y-2">
                 ...
                 <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full border border-gray-200 rounded-xl pl-12 pr-5 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand-yellow/20 focus:border-brand-yellow transition-all"
        ...
        <div className="md:col-span-2 flex justify-end gap-3 pt-4 ">
           ...
           <button 
             type="submit"
             disabled={loading}
             className={`px-10 py-3 rounded-xl font-semibold text-xs uppercase tracking-widest flex items-center gap-3 transition-all active:scale-95 ${loading ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-brand-yellow text-black shadow-lg shadow-brand-yellow/20 hover:shadow-brand-yellow/40 hover:bg-brand-orange'}`}
           >
              {loading ? (
                <div className="w-4 h-4 border-2 border-gray-400 border-t-transparent rounded-full w-fit animate-spin"></div>
