        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-between items-center px-1">
              ...
              <button
                onClick={addItem}
                className="flex items-center gap-2 bg-gray-900 hover:bg-black text-brand-yellow px-5 py-2.5 rounded-xl text-xs font-semibold uppercase tracking-widest transition-all shadow-lg active:scale-95"
              >
